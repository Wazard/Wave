...
extends GameContainer {
    ...
    protected void setup() throws SlickException {
        ...
        AccessController.doPrivileged(new PrivilegedAction(){
            ...
            public Object run() {
                try {
                    PixelFormat format = new PixelFormat(8, 8, 0, AppGameContainer.this.samples);
    ...
    static /* synthetic */ void access$000(AppGameContainer x0, PixelFormat x1) throws LWJGLException {
        x0.tryCreateDisplay(x1);
    }
