...
public class ContextCapabilities {
    ...
    private boolean GL32_initNativeFunctionAddresses() {
        ...
        this.glWaitSync = GLContext.getFunctionAddress("glWaitSync");
        this.glGetInteger64v = GLContext.getFunctionAddress("glGetInteger64v");
        boolean bl2 = bl & this.glDrawRangeElementsBaseVertex != 0L & this.glDrawElementsInstancedBaseVertex != 0L & this.glProvokingVertex != 0L & this.glTexImage2DMultisample != 0L & this.glTexImage3DMultisample != 0L & this.glGetMultisamplefv != 0L & this.glSampleMaski != 0L & this.glFramebufferTexture != 0L & this.glFenceSync != 0L & this.glIsSync != 0L & this.glDeleteSync != 0L & this.glClientWaitSync != 0L & this.glWaitSync != 0L & this.glGetInteger64v != 0L;
        this.glGetInteger64i_v = GLContext.getFunctionAddress("glGetInteger64i_v");
        if (this.glGetInteger64i_v == 0L) {
            // empty if block
        }
        return bl2 & true & (this.glGetSynciv = GLContext.getFunctionAddress("glGetSynciv")) != 0L;
    }
    ...
    private boolean GL42_initNativeFunctionAddresses() {
        this.glGetActiveAtomicCounterBufferiv = GLContext.getFunctionAddress("glGetActiveAtomicCounterBufferiv");
        if (this.glGetActiveAtomicCounterBufferiv == 0L) {
            // empty if block
        }
        boolean bl = true & (this.glTexStorage1D = GLContext.getFunctionAddress("glTexStorage1D")) != 0L;
    ...
    private boolean NV_half_float_initNativeFunctionAddresses() {
        ...
        this.glFogCoordhNV = GLContext.getFunctionAddress("glFogCoordhNV");
        this.glSecondaryColor3hNV = GLContext.getFunctionAddress("glSecondaryColor3hNV");
        boolean bl2 = bl & this.glVertex3hNV != 0L & this.glVertex4hNV != 0L & this.glNormal3hNV != 0L & this.glColor3hNV != 0L & this.glColor4hNV != 0L & this.glTexCoord1hNV != 0L & this.glTexCoord2hNV != 0L & this.glTexCoord3hNV != 0L & this.glTexCoord4hNV != 0L & this.glMultiTexCoord1hNV != 0L & this.glMultiTexCoord2hNV != 0L & this.glMultiTexCoord3hNV != 0L & this.glMultiTexCoord4hNV != 0L & this.glFogCoordhNV != 0L & this.glSecondaryColor3hNV != 0L;
        this.glVertexWeighthNV = GLContext.getFunctionAddress("glVertexWeighthNV");
        if (this.glVertexWeighthNV == 0L) {
            // empty if block
        }
        boolean bl3 = bl2 & true;
        this.glVertexAttrib1hNV = GLContext.getFunctionAddress("glVertexAttrib1hNV");
        if (this.glVertexAttrib1hNV == 0L) {
            // empty if block
        }
        boolean bl4 = bl3 & true;
        this.glVertexAttrib2hNV = GLContext.getFunctionAddress("glVertexAttrib2hNV");
        if (this.glVertexAttrib2hNV == 0L) {
            // empty if block
        }
        boolean bl5 = bl4 & true;
        this.glVertexAttrib3hNV = GLContext.getFunctionAddress("glVertexAttrib3hNV");
        if (this.glVertexAttrib3hNV == 0L) {
            // empty if block
        }
        boolean bl6 = bl5 & true;
        this.glVertexAttrib4hNV = GLContext.getFunctionAddress("glVertexAttrib4hNV");
        if (this.glVertexAttrib4hNV == 0L) {
            // empty if block
        }
        boolean bl7 = bl6 & true;
        this.glVertexAttribs1hvNV = GLContext.getFunctionAddress("glVertexAttribs1hvNV");
        if (this.glVertexAttribs1hvNV == 0L) {
            // empty if block
        }
        boolean bl8 = bl7 & true;
        this.glVertexAttribs2hvNV = GLContext.getFunctionAddress("glVertexAttribs2hvNV");
        if (this.glVertexAttribs2hvNV == 0L) {
            // empty if block
        }
        boolean bl9 = bl8 & true;
        this.glVertexAttribs3hvNV = GLContext.getFunctionAddress("glVertexAttribs3hvNV");
        if (this.glVertexAttribs3hvNV == 0L) {
            // empty if block
        }
        boolean bl10 = bl9 & true;
        this.glVertexAttribs4hvNV = GLContext.getFunctionAddress("glVertexAttribs4hvNV");
        if (this.glVertexAttribs4hvNV == 0L) {
            // empty if block
        }
        return bl10 & true;
    }
