...
extends BaseReferences {
    ...
    Buffer EXT_gpu_shader4_glVertexAttribIPointerEXT_buffer;
    ...
    void copy(References references, int mask) {
        ...
        if ((mask & 2) != 0) {
            ...
            this.GL30_glVertexAttribIPointer_buffer = references.GL30_glVertexAttribIPointer_buffer;
        }
    }
    ...
    void clear() {
        ...
        this.GL30_glVertexAttribIPointer_buffer = null;
    }
}
