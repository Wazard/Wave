...
public final class CL10 {
    ...
    public static int clGetProgramInfo(CLProgram program, PointerBuffer sizes, ByteBuffer param_value, PointerBuffer param_value_size_ret) {
        ...
        int __result = CL10.nclGetProgramInfo2(program.getPointer(), 4454, sizes.remainingByte(), MemoryUtil.getAddress(sizes), MemoryUtil.getAddress(param_value), MemoryUtil.getAddressSafe(param_value_size_ret), function_pointer);
        return __result;
    }
    ...
    public static int clGetProgramInfo(CLProgram program, ByteBuffer[] param_value, PointerBuffer param_value_size_ret) {
        ...
        int __result = CL10.nclGetProgramInfo3(program.getPointer(), 4454, param_value.length * PointerBuffer.getPointerSize(), param_value, MemoryUtil.getAddressSafe(param_value_size_ret), function_pointer);
        return __result;
    }
    ...
    static CLFunctionAddress clGetExtensionFunctionAddress(CharSequence func_name) {
        long function_pointer = CLCapabilities.clGetExtensionFunctionAddress;
        BufferChecks.checkFunctionAddress(function_pointer);
        CLFunctionAddress __result = new CLFunctionAddress(CL10.nclGetExtensionFunctionAddress(APIUtil.getBuffer(func_name), function_pointer));
        return __result;
    }
}
